...
class PopupRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type PopupRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type PopupRequest
    let len;
    let data = new PopupRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new PopupRequest(null);
...
class PopupResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type PopupResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type PopupResponse
    let len;
    let data = new PopupResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new PopupResponse(null);
...
module.exports = {
  ...
  datatype() { return 'ur_dashboard_msgs/Popup'; }
};
